    ...
    public ICommandResult execute(ICommandContext<? extends CommandSource> context) throws CommandException {
        ...
        if (speed == null) {
            Text t = Text.builder().append(context.getMessage("command.speed.walk")).append(Text.of(" "))
                    .append(Text.of(TextColors.YELLOW, pl.get(Keys.WALKING_SPEED).orElse(0.1d) * multiplier))
        ...
        DataTransactionResult dtr = pl.offer(key.speedKey, speed / (double) multiplier);
