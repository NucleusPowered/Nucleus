...
@RegisterCommand(value = {"close"}, subcommandOf = TicketCommand.class)
public class CloseTicketCommand extends AbstractCommand<CommandSource> {
    @Inject
    ...
    protected CommandResult executeCommand(CommandSource src, CommandContext args) throws Exception {
        ...
        CompletableFuture<Boolean> future = ticketHandler.closeTicket(id);
