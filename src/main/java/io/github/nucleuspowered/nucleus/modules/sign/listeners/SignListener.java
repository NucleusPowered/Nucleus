...
public class SignListener extends ListenerBase {
    ...
    private final String bypass = PermissionRegistry.PERMISSIONS_PREFIX + "sign.formatting";
    ...
    protected Map<String, PermissionInformation> getPermissions() {
        ...
        mp.put(bypass, new PermissionInformation(Util.getMessageWithFormat("permission.sign.formatting"), SuggestedLevel.ADMIN));
        return mp;
    }
}
